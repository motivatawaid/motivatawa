...
// Halaman all-event dan all-video
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::middleware(['can:user'])->prefix('my')->name('user.')->group(function () {
        ...
        Route::post('/events/{event}/buy-event', [UserEventController::class, 'buy'])->name('events.buy'); // Diubah ke buy-event & UserEventController
