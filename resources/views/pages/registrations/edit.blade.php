...
@section('desc', 'Di halaman ini anda bisa edit registration.')

@section('content')
<form action="{{ route('registrations.update', $item->id) }}" method="POST">
    @method('PUT')
    @csrf
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input value="{{ old('whatsapp_number', $item->whatsapp_number) }}" type="text"
